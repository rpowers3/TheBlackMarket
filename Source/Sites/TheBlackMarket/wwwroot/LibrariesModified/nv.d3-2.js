	...
	*/
	...
	nv.models.bulletChart = function() {
		...
		chart._options = Object.create({}, {
			...
			// deprecated options
			tooltips: {
				get: function() { return tooltip.enabled(); }, set: function(_) {
	...
	nv.models.parallelCoordinates = function() {
		...
		chart._options = Object.create({}, {
			...
			// deprecated options
			dimensions: {
				get: function() { return dimensionNames; }, set: function(_) {
