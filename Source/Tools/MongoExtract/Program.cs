	...
	public class Program {
		...
		public void Main(string[] args) {
			var sets = new string[] {
				...
				@"-d TheBlackMarket -c ItemWinRatesOverTimeC -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeC -i _id.championId -f c{0}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeG -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeG -i _id.global -f {0}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeRC -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeRC -i _id.region,_id.championId -f r{0}c{1}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeR -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeR -i _id.region -f r{0}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeRTC -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeRTC -i _id.region,_id.teamId,_id.championId -f r{0}t{1}c{2}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeRT -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeRT -i _id.region,_id.teamId -f r{0}t{1}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeTC -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeTC -i _id.teamId,_id.championId -f t{0}c{1}",
				@"-d TheBlackMarket -c ItemWinRatesOverTimeT -o G:\Projects\TheBlackMarket\Data\Json\ItemWinRatesOverTimeT -i _id.teamId -f t{0}",
